...
// RepositoryInterface define os métodos que o repositório deve implementar
type RepositoryInterface interface {
	FindByID(ctx context.Context, id string) (*Usuario, error)
	FindByLogin(ctx context.Context, login string) (*Usuario, error)
	Insert(ctx context.Context, u *Usuario) error
	Update(ctx context.Context, id string, u *Usuario) error
	Delete(ctx context.Context, id string) error
	UpdateLastLogin(ctx context.Context, id string) error
	List(ctx context.Context, pagina, limite int, busca, status, permissao *string) ([]Usuario, int, error)
}
